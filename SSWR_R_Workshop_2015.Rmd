...
cis_df$plc_dec <- c("p","inf", "con", "no")
library(reshape2)
library(ggplot2)
cis_df <- melt(cis_df)

ggplot(cis_df, aes(y=value, x=variable)) + 
...
## Some of our blog entries. 

- [Mapping Placement Mobility](http://partnersforourchildren.org/about-us/blog/family-home-foster-home-how-far-do-foster-children-move)
- [Timing of CPS Referrals](http://partnersforourchildren.org/about-us/blog/does-referral-time-matter)

## Some more `ggplot` examples. 

- [`geom_smooth()`](http://docs.ggplot2.org/0.9.3.1/geom_smooth.html)
- [`geom_violin()`](http://docs.ggplot2.org/0.9.3.1/geom_violin.html)
