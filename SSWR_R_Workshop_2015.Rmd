...
author: 'Joseph Mienko, David Rothwell, Richard Smith, & Gregor Thomas-Passolt'
output:
...
print(Table3, include.rownames=FALSE, floating=FALSE, scalebox=.5,type="html")
```
...
ggplot(tr6,aes(x=OR,y=Variable))+
  theme_bw()+
  geom_point(aes(shape = signif), size = 2.5) +
  ...
  theme(legend.direction="vertical",
        ...
        panel.grid.major=element_line(color="grey80",linetype='dashed', size = 0.3))
```
...
print(Table4, include.rownames=FALSE, floating=FALSE, scalebox=.8,type="html")
```
